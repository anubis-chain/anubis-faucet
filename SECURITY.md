...
Security fixes are applied to the latest revision of `main`. The hosted faucet may be deployed from a newer private operational revision, so include the affected URL and observation time in a report.

## Report a vulnerability

Email **anubis.chain@proton.me** with:

- `anubis-faucet` in the subject
